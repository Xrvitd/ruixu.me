...
export function Intro() {
  return (
    <h1 className="text-neutral-900  font-light">
      ...
      <span className="font-medium">Prof. Changhe Tu</span> and{' '}
      <span className="font-medium">Prof. Shiqing Xin</span>. My research
      interests are computer graphics, computational geometry, point cloud
      reconstruction and geometric modeling.
    </h1>
  )
}
